    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="list-group mt-4">
                <a href="<?php echo BASE_URL; ?>profile" class="list-group-item list-group-item-action active">
                    <i class="fas fa-user me-2"></i>Thông tin cá nhân
                </a>
                <a href="<?php echo BASE_URL; ?>profile/change-password" class="list-group-item list-group-item-action">
