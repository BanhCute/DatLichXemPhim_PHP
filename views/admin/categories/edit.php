...
<div class="container mt-4">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0"><i class="fas fa-edit me-2"></i>Sửa thể loại</h4>
        </div>
        <div class="card-body">
            ...
            <form action="<?php echo BASE_URL; ?>admin/categories/edit?id=<?php echo $category['id']; ?>" method="post">
                <div class="mb-3">
...
<script>
    document.getElementById('name').addEventListener('input', function() {
        // Tự động tạo slug khi nhập tên (nếu người dùng chưa nhập slug)
